...
public class Principal {
    public static void main(String[] args) throws ParseException {
        ...
        EntidadeEndereco enderecoJoao = new EntidadeEndereco("Rua A", "123", "Apto 4B", "Cidade 1", "Estado 1", "12345-678");
        EntidadeEndereco enderecoMaria = new EntidadeEndereco("Rua B", "456", "Casa 2", "Cidade 2", "Estado 2", "98765-432");
        EntidadeEndereco enderecoLucas = new EntidadeEndereco("Rua C", "789", "Casa 3", "Cidade 3", "Estado 3", "54321-876");
        EntidadeEndereco enderecoTeste = new EntidadeEndereco("Rua A", "123", "Apto 4B", "Cidade 1", "Estado 1", "12345-678");
