...
public class GerenciadorPlanos implements ServicoGerenciadorPlanos {
	...
	public boolean registrarPlanoParaCliente(EntidadeCliente cliente, String nomePlano, EnumeradorPeriodo periodo,
			List<ServicoModalidade> modalidadesDisponiveis, List<EnumeradorFormaPagamento> formasPagamentoAceitas,
			double preco) {

		if (cliente != null) {
			EntidadePlano plano = new EntidadePlano(nomePlano, periodo, modalidadesDisponiveis, formasPagamentoAceitas,
					preco);
